    ...
    return (
        ...
        <section className="grid grid-cols-1 sm:flex-wrap md:grid-cols-2 lg:grid-cols-3 gap-5 mx-2 py-5">
            ...
            <div className="lg:flex mt-8 sm:mt-10 md:mt-10 lg:mt-0 mx-auto">
                <div className="relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                    <div className="relative mx-4 -mt-6 h-40 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40 bg-gradient-to-r from-blue-500 to-blue-600">
                    <a href="https://github.com/OxidiLily/streamlit-ollama-local.git" target="_blank">
                        <img src={Ollama} alt="Streamlit" className="relative object-fit h-44" />
                    </a>
                    </div>
                    <div className="p-6">
                        <a href="https://github.com/OxidiLily/streamlit-ollama-local.git" target="_blank">
                            <h5 className="mb-2 block font-sans text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
                            Buat Streamlit AI Local
                            </h5>
                        </a>                    
                        <p className="block font-sans text-base font-normal italic leading-relaxed text-inherit antialiased">
                        AI Model, docker dan streamlit.
                        </p>
                    </div>
                    <div className="p-6 pt-0">
                        <a href="https://github.com/OxidiLily/streamlit-ollama-local.git" target="_blank">
